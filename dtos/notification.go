...
const (
	...
	UpdateTypeConfigChange       = "CONFIG_UPDATE"
)
...
// ConfigChangeUpdate represents a config change notification generated by the configs API.
// The definition is carried as an opaque, already-decoded-and-decompressed JSON string;
// this package does not know the shape of a config definition.
...
func NewConfigChangeUpdate(baseUpdate BaseUpdate, pcn *int64, definition *string, compression *int) *ConfigChangeUpdate {
	return &ConfigChangeUpdate{
		BaseUpdate:           baseUpdate,
		previousChangeNumber: pcn,
...
// UpdateType is always UpdateTypeConfigChange for Config Updates
func (u *ConfigChangeUpdate) UpdateType() string { return UpdateTypeConfigChange }

// PreviousChangeNumber returns the previous change number, or nil if the notification
// carried no usable definition.
func (u *ConfigChangeUpdate) PreviousChangeNumber() *int64 { return u.previousChangeNumber }

// Definition returns the decoded, decompressed JSON definition, or nil if absent/malformed.
func (u *ConfigChangeUpdate) Definition() *string { return u.definition }

// Compression returns the compression type used to encode the definition.
func (u *ConfigChangeUpdate) Compression() *int { return u.compression }

// String returns the string representation of a config change notification
func (u *ConfigChangeUpdate) String() string {
	return fmt.Sprintf("ConfigChange(channel=%s,changeNumber=%d,timestamp=%d)",
		u.Channel(), u.ChangeNumber(), u.Timestamp())
}
...
var _ Message = &ConfigChangeUpdate{}
...
var _ Update = &ConfigChangeUpdate{}
