...
func TestGreaterThanOrEqualToSemverMatcher(t *testing.T) {
	...
	for _, twoSemvers := range semvers {
		...
		if matcherType != "*grammar.GreaterThanOrEqualToSemverMatcher" {
			t.Errorf("Incorrect matcher constructed. Should be *grammar.GreaterThanOrEqualToSemverMatcher and was %s", matcherType)
		}
...
func TestLessThanOrEqualToSemverMatcher(t *testing.T) {
	...
	for _, twoSemvers := range semvers {
		...
		if matcherType != "*grammar.LessThanOrEqualToSemverMatcher" {
			t.Errorf("Incorrect matcher constructed. Should be *grammar.LessThanOrEqualToSemverMatcher and was %s", matcherType)
		}
...
func TestBetweenSemverMatcher(t *testing.T) {
	...
	for _, threeSemvers := range semvers {
		...
		if matcherType != "*grammar.BetweenSemverMatcher" {
			t.Errorf("Incorrect matcher constructed. Should be *grammar.BetweenSemverMatcher and was %s", matcherType)
		}
...
func TestInListSemvers(t *testing.T) {
	...
	if matcherType != "*grammar.InListSemverMatcher" {
		t.Errorf("Incorrect matcher constructed. Should be *grammar.InListSemverMatcher and was %s", matcherType)
	}
