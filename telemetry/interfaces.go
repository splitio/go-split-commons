...
// FacadeProducer interface should be implemented by structs that accept incoming telemetry
...
// FacadeConsumer interface should be implemented by structs that offer popping telemetry
