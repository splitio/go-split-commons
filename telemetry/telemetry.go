...
func NewTelemetry(telemetryStorage storage.TelemetryStorage, splitStorage storage.SplitStorageConsumer, segmentStorage storage.SegmentStorageConsumer) Facade {
	return &FacadeImpl{
...
func (t *FacadeImpl) PopLatencies() dtos.MethodLatencies {
	return t.storage.PopLatencies()
}

// PopExceptions returns exceptions
func (t *FacadeImpl) PopExceptions() dtos.MethodExceptions {
...
func (t *FacadeImpl) GetLastSynchronization() dtos.LastSynchronization {
...
func (t *FacadeImpl) PopHTTPErrors() dtos.HTTPErrors {
	return t.storage.PopHTTPErrors()
}

// PopHTTPLatencies returns latencies stored
func (t *FacadeImpl) PopHTTPLatencies() dtos.HTTPLatencies {
...
func (t *FacadeImpl) PopStreamingEvents() []dtos.StreamingEvent {
